...
class Movie2Adapter(var mOnMovieListener: OnMovieListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): RecyclerView.ViewHolder {
        ...
        return when (i) {
            MOVIE_TYPE -> {
                ...
                Movie2ViewHolder(view, mOnMovieListener)
            }
            LOADING_TYPE -> {
                view = LayoutInflater.from(viewGroup.context).inflate(R.layout.layout_movie_list_item, viewGroup, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, i: Int) {
        if(getItemViewType(i) == MOVIE_TYPE){
            viewHolder as Movie2ViewHolder
